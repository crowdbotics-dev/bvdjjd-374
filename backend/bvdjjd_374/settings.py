"""
Django settings for bvdjjd_374 project.
...
WSGI_APPLICATION = 'bvdjjd_374.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bvdjjd_374 API",
    "DESCRIPTION": "API documentation for bvdjjd_374 App",
    "VERSION": "v1",
}
